...
export class Transit extends BaseEntity {
  ...
  @ManyToMany(() => Driver)
  public driversRejections: Set<Driver>;

  @ManyToMany(() => Driver)
  public proposedDrivers: Set<Driver>;
  ...
  public setDriversRejections(driversRejections: Set<Driver>) {
  ...
  public setProposedDrivers(proposedDrivers: Set<Driver>) {
